...
class InterfaceRedesign extends Component {
    render() {
      return (
    <div>
        <Header/>
        <div class="body">
        <div class="title">
            <h1> Interface Redesign </h1>
            <h2>The Sewing Machine</h2>
        </div>
        <div class="section">
  ...
  export default InterfaceRedesign;